...
const PaymentHistory = () => {
  ...
  return (
    <div className="overflow-x-auto mt-4">
      <table
        {...getTableProps()}
        className="min-w-full table-auto text-sm text-left text-base-content border-separate border-spacing-y-3"
      >
            ...
            <tr {...headerGroup.getHeaderGroupProps()}>
              {headerGroup.headers.map((column) => (
                <th
                  ...
                  className="px-4 py-3 text-sm text-base-content/60"
                >
        ...
        <tbody {...getTableBodyProps()} className="divide-y divide-base-200">
          {rows.map((row) => {
            prepareRow(row);
            return (
              <tr
